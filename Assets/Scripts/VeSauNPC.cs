...
public class VeSauNPC : MonoBehaviour
{
    [Header("NPC Discovery")]
    public string npcName = "Anh Ve Sầu";
    ...
    public List<string> dialogueLines = new List<string>() {
        "Hè về rồi! Hãy cùng tôi hát vang bài ca mùa hè nào!",
        "Ve ve ve... Âm nhạc là cuộc sống của tôi.",
        "Cậu có muốn nghe tôi biểu diễn một bản nhạc không?"
    };
