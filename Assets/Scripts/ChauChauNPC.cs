...
public class ChauChauNPC : MonoBehaviour
{
    [Header("NPC Discovery")]
    public string npcName = "Châu Chấu";
    ...
    public List<string> dialogueLines = new List<string>() {
        "Ồ, chào chú Dế Mèn! Chú có muốn cùng tôi thi nhảy cao không?",
        "Bãi cỏ này thật xanh mướt, rất thích hợp để dạo chơi.",
        "Đừng quên tập luyện đôi chân mỗi ngày nhé!"
    };
